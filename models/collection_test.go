...
func TestCollectionMarshalJSON(t *testing.T) {
	scenarios := []struct {
	...
	}{
		{
			...
			`{"id":"","created":"","updated":"","name":"test","type":"","system":false,"schema":[],"indexes":[],"displayName":null,"project":null,"cacheEnabled":false,"listCacheEnabled":false,"searchCacheEnabled":false,"cacheDuration":0,"listRule":null,"viewRule":null,"createRule":null,"updateRule":null,"deleteRule":null,"options":{}}`,
		},
		{
			...
			`{"id":"","created":"","updated":"","name":"test","type":"unknown","system":false,"schema":[],"indexes":["idx_test"],"displayName":null,"project":null,"cacheEnabled":false,"listCacheEnabled":false,"searchCacheEnabled":false,"cacheDuration":0,"listRule":"test_list","viewRule":null,"createRule":null,"updateRule":null,"deleteRule":null,"options":{}}`,
		},
		{
			...
			`{"id":"","created":"","updated":"","name":"test","type":"base","system":false,"schema":[],"indexes":[],"displayName":null,"project":null,"cacheEnabled":false,"listCacheEnabled":false,"searchCacheEnabled":false,"cacheDuration":0,"listRule":"test_list","viewRule":null,"createRule":null,"updateRule":null,"deleteRule":null,"options":{}}`,
		},
		{
			...
			`{"id":"test","created":"","updated":"","name":"","type":"auth","system":false,"schema":[],"indexes":[],"displayName":null,"project":null,"cacheEnabled":false,"listCacheEnabled":false,"searchCacheEnabled":false,"cacheDuration":0,"listRule":null,"viewRule":null,"createRule":null,"updateRule":null,"deleteRule":null,"options":{"allowEmailAuth":false,"allowOAuth2Auth":true,"allowUsernameAuth":false,"exceptEmailDomains":null,"manageRule":null,"minPasswordLength":4,"onlyEmailDomains":null,"requireEmail":false}}`,
		},
	}
