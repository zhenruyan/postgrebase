import{S as re,i as ae,s as be,N as pe,C as P,e as p,w as y,b as a,c as te,f as u,g as t,h as I,m as ne,x as ue,t as ie,a as ce,o as n,d as le,T as me,p as de}from"./index-94472d42.js";import{S as fe}from"./SdkTabs-7b9415b9.js";function $e(s){var B,U,W,T,A,H,L,q,M,N,j,J;let i,m,c=s[0].name+"",b,d,h,f,_,$,k,l,C,v,S,R,w,g,E,r,D;return l=new fe({props:{js:`
    ...
    <div class="contet"><p><strong>You could subscribe to a single record or to an entire collection.</strong></p> 
        ...
        <p>When you subscribe to an <strong>entire collection</strong>, the collection&#39;s
            ...
            event message.</p></div>`,k=a(),te(l.$$.fragment),C=a(),v=p("h6"),v.textContent="API details",S=a(),R=p("div"),R.innerHTML=`<strong class="label label-primary">SSE</strong> 
    <div class="content"><p>/api/realtime</p></div>`,w=a(),g=p("div"),g.textContent="Event data format",E=a(),te(r.$$.fragment),u(i,"class","m-b-sm"),u(f,"class","content txt-lg m-b-sm"),u($,"class","alert alert-info m-t-10 m-b-sm"),u(v,"class","m-b-xs"),u(R,"class","alert"),u(g,"class","section-title")},m(e,o){t(e,i,o),I(i,m),I(i,b),I(i,d),t(e,h,o),t(e,f,o),t(e,_,o),t(e,$,o),t(e,k,o),ne(l,e,o),t(e,C,o),t(e,v,o),t(e,S,o),t(e,R,o),t(e,w,o),t(e,g,o),t(e,E,o),ne(r,e,o),D=!0},p(e,[o]){var Y,z,F,G,K,Q,X,Z,x,ee,oe,se;(!D||o&1)&&c!==(c=e[0].name+"")&&ue(b,c);const O={};o&3&&(O.js=`
        import PocketBase from 'pocketbase';
    ...
    `),l.$set(O);const V={};o&1&&(V.content=JSON.stringify({action:"create",record:P.dummyCollectionRecord(e[0])},null,2).replace('"action": "create"','"action": "create" // create, update or delete')),r.$set(V)},i(e){D||(ie(l.$$.fragment,e),ie(r.$$.fragment,e),D=!0)},o(e){ce(l.$$.fragment,e),ce(r.$$.fragment,e),D=!1},d(e){e&&n(i),e&&n(h),e&&n(f),e&&n(_),e&&n($),e&&n(k),le(l,e),e&&n(C),e&&n(v),e&&n(S),e&&n(R),e&&n(w),e&&n(g),e&&n(E),le(r,e)}}}function ve(s,i,m){let c,{collection:b=new me}=i;return s.$$set=d=>{"collection"in d&&m(0,b=d.collection)},m(1,c=P.getApiExampleUrl(de.baseUrl)),[b,c]}class De extends re{constructor(i){super(),ae(this,i,ve,$e,be,{collection:0})}}export{De as default};
